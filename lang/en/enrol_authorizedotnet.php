...
$string['currencyunavailable'] = 'Unable to retrieve your Authorize.net account currency. Check your API Login ID, Transaction Key, and whether the "Enable test Mode" setting matches the type of credentials entered (enabled for sandbox credentials, disabled for production credentials). See the Moodle log for the exact error returned by Authorize.net.';
...
$string['pay'] = 'Pay';
$string['paymentunavailable'] = 'Online payment is temporarily unavailable for this course. Please contact the site administrator.';
